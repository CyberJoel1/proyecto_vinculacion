  ...
  const actualizar = async () => {
    try {
      const response = await fetch(
        "http://192.188.58.82:3000/actualizarAdultoMayorById/" + values.id + "",
        {
          method: "POST",
          headers: {
      ...
      <ScrollView>
        ...
        >
          ...
          <TouchableOpacity
            ...
            style={[
              values.disabled ? stylesInfo.btnActualizarDisabled : null,
              !values.disabled ? stylesInfo.btnActualizar : null,
            ]}
            onPress={actualizar}
          >
            <Text style={stylesInfo.textBtn}>Actualizar</Text>
