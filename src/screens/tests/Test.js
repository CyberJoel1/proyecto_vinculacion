...
export const Test = (props) => {
  ...
  const [state, setstate]=useState({
    isReady: false,
    listadoAdultMay: [],
    id: props.route.params.params.id,
    nombre: props.route.params.params.nombre,
    apellido: props.route.params.params.apellido,
    cedula: props.route.params.params.cedula,
    domicilio: props.route.params.params.domicilio,
    autoidentificacion: props.route.params.params.autoidentificacion,
    genero: props.route.params.params.genero,
    edad: props.route.params.params.edad,
  });
